...
/**
  ...
  */
#if defined(MQTTV5)
int32_t MQTTV5Serialize_connect(unsigned char* buf, int32_t buflen, MQTTV5Packet_connectData* options,
  MQTTProperties* connectProperties)
#else
int32_t MQTTSerialize_connect(unsigned char* buf, int32_t buflen, MQTTPacket_connectData* options)
#endif
{
...
/**
  ...
  */
#if defined(MQTTV5)
int32_t MQTTV5Deserialize_connack(MQTTProperties* connackProperties, unsigned char* sessionPresent, unsigned char* connack_rc,
	unsigned char* buf, int32_t buflen)
#else
int32_t MQTTDeserialize_connack(unsigned char* sessionPresent, unsigned char* connack_rc, unsigned char* buf, int32_t buflen)
#endif
{
	MQTTHeader header = {0};
...
/**
  ...
  */
#if defined(MQTTV5)
int32_t MQTTV5Serialize_disconnect(unsigned char* buf, int32_t buflen,
	            unsigned char reasonCode, MQTTProperties* properties)
#else
int32_t MQTTSerialize_disconnect(unsigned char* buf, int32_t buflen)
#endif
{
#if defined(MQTTV5)
...
#if defined(MQTTV5)
int32_t MQTTV5Serialize_auth(unsigned char* buf, int32_t buflen,
	            unsigned char reasonCode, MQTTProperties* properties)
{
