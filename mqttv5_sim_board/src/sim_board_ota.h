#ifndef SIM_BOARD_OTA_H
#define SIM_BOARD_OTA_H
...
#define SIM_BOARD_APP2_SECTOR_COUNT ((SIM_BOARD_APP2_END_ADDR - SIM_BOARD_APP2_START_ADDR) / SIM_BOARD_FLASH_PAGE_SIZE)
...
#define SIM_BOARD_OTA_MAX_CHUNK_SIZE 1024U
